            ...
            <div key={customer.id} className="glass" style={{ padding: "30px", borderRadius: "16px" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", borderBottom: "1px solid var(--glass-border)", paddingBottom: "20px", marginBottom: "20px" }}>
                <div style={{ display: "flex", gap: "20px" }}>
                  ...
                  <div>
                    <h3 style={{ fontSize: "24px", fontWeight: "600", color: "var(--text-main)", marginBottom: "5px" }}>{customer.name}</h3>
              ...
              <div style={{ overflowX: "auto" }}>
                <table style={{ width: "100%", borderCollapse: "collapse", textAlign: "left" }}>
                  <thead>
                    <tr style={{ color: "var(--text-muted)", fontSize: "14px", borderBottom: "1px solid var(--border-subtle)" }}>
                  ...
                  <tbody>
                    {customerLoans.map(loan => (
                      <tr key={loan.id} style={{ borderBottom: "1px solid var(--border-subtle)" }}>
                        <td style={{ padding: "12px 10px", fontWeight: "600", color: "var(--text-main)" }}>{loan.id}</td>
