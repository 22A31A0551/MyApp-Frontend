              ...
              <div className="fade-in">
                ...
                {userRole === "admin" ? (
                  <>
                    ...
                    <div className="glass" style={{ margin: "60px 0", padding: "30px", borderRadius: "24px" }}>
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px" }}>
                        <h3 style={{ fontSize: "20px", color: "#000" }}>Recent Transactions</h3>
                        <button 
                      ...
                      <div style={{ display: "flex", flexDirection: "column", gap: "15px" }}>
                        {recentTransactions.length > 0 ? recentTransactions.map((t) => (
                          ...
                          <div style={{ textAlign: "center", padding: "20px", color: "#64748b" }}>No recent transactions.</div>
                        )}
                      </div>
                    </div>
                  </>
                ) : (
                  <div className="glass-card" style={{ padding: "60px 20px", textAlign: "center", borderRadius: "24px", margin: "40px 0" }}>
