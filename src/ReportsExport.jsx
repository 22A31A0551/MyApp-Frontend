...
const ReportPlaceholder = ({ title, desc }) => (
  <div style={{ textAlign: "center", maxWidth: "400px" }}>
    <h3 style={{ fontSize: "22px", color: "white", marginBottom: "15px" }}>{title} Preview</h3>
    <p style={{ color: "var(--text-muted)", lineHeight: "1.6", marginBottom: "30px" }}>{desc}</p>
    <div style={{ padding: "20px", background: "rgba(255,255,255,0.02)", border: "1px dashed var(--glass-border)", borderRadius: "12px", color: "var(--text-muted)" }}>
